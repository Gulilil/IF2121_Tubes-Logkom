                            ...
                            ( (Loc1 == '1C'; Loc1 == '2C'; Loc1 == '3C' ), getChanceCard(Money1,X,_Card),
                                   (_Card = 'Free $1000', NewMoney is Money1 + 1000, retract(player1(ID1,Loc1, Money1,List)), asserta(player1(ID1, Loc1, NewMoney, List));
                                    ...
                                    _Card = 'Go To Tax', tile(_,_,Loc1,Idx), 
                                                        ((Idx > 28 ; Idx < 4) ->  retract(player1(ID1,Loc1, Money1,List)), asserta(player1(ID1, '1X', Money1, List)) , wentInTX(ID1); 
                                                                                    retract(player1(ID1,Loc1, Money1,List)), asserta(player1(ID1, '2X', Money1, List)), wentInTX(ID1));
                            ...
                            ( (Loc2 == '1C'; Loc2 == '2C'; Loc2 == '3C' ), getChanceCard(Money2,X,_Card),
                                   (_Card = 'Free $1000', NewMoney is Money2 + 1000, retract(player2(ID2,Loc2, Money2,List)), asserta(player2(ID2, Loc2, NewMoney, List));
                                    ...
                                    _Card = 'Go To Tax', tile(_,_,Loc2,Idx), 
                                                        ((Idx > 28 ; Idx < 4) ->  retract(player2(ID2,Loc2, Money2,List)), asserta(player2(ID2, '1X', Money2, List)) , wentInTX(ID2); 
                                                                                    retract(player2(ID2,Loc2, Money2,List)), asserta(player2(ID2, '2X', Money2, List)), wentInTX(ID2));
...
checkPlayer1LocationBefore(CanMove) :- player1(P1ID,P1Loc, P1Money,_), 
                            ...
                            (P1Loc = 'WT', goWorldTour(1, FinalLoc, MoneyChanges), 
                            write('Petak Tujuan : '), write(FinalLoc), nl,
                            write('Perubahan Uang : '), write(MoneyChanges), nl, NewMoney is P1Money + MoneyChanges,
...
checkPlayer2LocationBefore(CanMove) :- player2(P2ID,P2Loc, P2Money,_), 
                            ...
                            (P2Loc = 'WT', goWorldTour(2, FinalLoc, MoneyChanges),
                            write('Petak Tujuan : '), write(FinalLoc), nl,
                            write('Perubahan Uang : '), write(MoneyChanges), nl,  NewMoney is P2Money + MoneyChanges,
