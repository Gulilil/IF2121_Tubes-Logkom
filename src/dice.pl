...
diceRandomizer1(X,Y,Result1,Result2):- Z is round(Y), Temp1 is mod(2*Z - X+230,6), dice(Temp1,Angka1), Result1 is 1, 
                                                      Temp2 is mod(5*Z-X+99,6), dice(Temp2,Angka2),Result2 is 1.
...
diceRandomizer2(X,Y,Result1,Result2):- Z is round(Y), Temp1 is mod(3*Z - X+565,6), dice(Temp1,Angka1), Result1 is 2,
                                                      Temp2 is mod(7*Z - X -84,6), dice(Temp2,Angka2),Result2 is 4.
